...
{
    struct aes_sbox_constants *res = malloc(sizeof(struct aes_sbox_constants));
...
{
    struct aes_ttable_constants *res = malloc(sizeof(struct aes_ttable_constants));

    memcpy(res->t0, t0, sizeof(t0));
    memcpy(res->t1, t1, sizeof(t1));
    memcpy(res->t2, t2, sizeof(t2));
    memcpy(res->t3, t3, sizeof(t3));
    memcpy(res->sbox, sbox, sizeof(sbox));
    memcpy(res->rc_lookup, rc_lookup, sizeof(rc_lookup));
