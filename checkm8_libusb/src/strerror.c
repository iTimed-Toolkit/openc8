 ...
 *      https://raw.github.com/src/src/master/src/strerror.c </li>
 ...
 * <li> Save the file (in UTF-8 format) and send it to \c src-devel\@lists.sourceforge.net </li>
 * </ol>
 */
 ...
 * Note that the src log messages controlled through libusb_set_debug()
 * are not translated, they are always in English.
 *
 * For POSIX UTF-8 environments if you want src to follow the standard
