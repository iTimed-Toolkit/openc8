...
/*
 * USB descriptor handling functions for src
 ...
 *
 * Note since src-1.0.16, \ref LIBUSB_API_VERSION >= 0x01000102, this
 ...
 *
 * \param dev_handle the handle of an open src device
