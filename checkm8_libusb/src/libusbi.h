...
/* Inside the src code, mark all public functions as follows:
 *   return_type API_EXPORTED function_name(params) { ... }
 * But if the function returns a pointer, mark it as follows:
 *   DEFAULT_VISIBILITY return_type * LIBUSB_CALL function_name(params) { ... }
 * In the src public header, mark all declarations as:
...
struct usbi_os_backend {
	 ...
	 *
	 * This function is called when a src user initializes the library
	 * prior to use.
	 *
	 ...
	 * usbi_get_device_by_session_id(). This function checks if src already
	 ...
	 * without hiccup. This is also a good place to inform src that it
	 ...
	 * src of any file descriptors associated with this device that should
	 ...
	 * src to retrieve the information through a standard control transfer.
	 *
	 ...
	 *
	 * This function might seem a bit out of place. It is used when src
