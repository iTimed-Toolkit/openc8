...
/*
 * Synchronous I/O functions for src
 ...
 *
 * This page documents src's synchronous (blocking) API for USB device I/O.
 ...
 * src may have to split your transfer into a number of chunks to satisfy
 * underlying O/S requirements, meaning that the timeout may expire after
 * the first few chunks have completed. src is careful not to lose any data
