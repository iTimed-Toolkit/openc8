 ...
 * This page details how to use the src hotplug interface, where available.
 *
 ...
 * safe to call any src function that takes a libusb_device. It also safe to
